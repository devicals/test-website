"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[203], {
    1382: function(e, t, n) {
        let r;
        n.d(t, {
            x8: function() {
        ...
        var o, a, i, u, c, l, s, d = n(5271), f = n(5061), p = n(1224), v = n(9407), h = n(5065), m = n(9945), g = n(1027), y = n(9939), b = n(116), w = n(2676), E = "focusScope.autoFocusOnMount", x = "focusScope.autoFocusOnUnmount", C = {
            bubbles: !1,
            cancelable: !0
        }, S = d.forwardRef( (e, t) => {
                ...
                if (r) {
                    let e = function(e) {
                        if (h.paused || !u)
                            return;
                        let t = e.target;
                        u.contains(t) ? f.current = t : M(f.current, {
                            select: !0
                        })
                    }
                      , t = function(e) {
                        ...
                        null === t || u.contains(t) || M(f.current, {
                            select: !0
                        })
                    };
            ...
            d.useEffect( () => {
                if (u) {
                    ...
                    return () => {
                        u.removeEventListener(E, l),
                        setTimeout( () => {
                            let t = new CustomEvent(x,C);
                            u.addEventListener(x, s),
                            u.dispatchEvent(t),
                            t.defaultPrevented || M(e ?? document.body, {
                                select: !0
                            }),
                            u.removeEventListener(x, s),
                            N.remove(h)
                        }
                        , 0)
                    }
            ...
            let m = d.useCallback(e => {
                ...
                if (t && o) {
                    ...
                    r && a ? e.shiftKey || o !== a ? e.shiftKey && o === r && (e.preventDefault(),
                    n && M(a, {
                        select: !0
                    })) : (e.preventDefault(),
                    n && M(r, {
        ...
        var _ = "undefined" != typeof window ? d.useLayoutEffect : d.useEffect
          , B = new WeakMap
          , V = (void 0 === o && (o = {}),
        ...
        c)
          ...
          , K = d.forwardRef(function(e, t) {
            var n, r, o, a, i = d.useRef(null), u = d.useState({
                onScrollCapture: z,
                onWheelCapture: z,
                onTouchMoveCapture: z
            }), c = u[0], l = u[1], s = e.forwardProps, f = e.children, p = e.className, v = e.removeScrollBar, h = e.enabled, m = e.shards, g = e.sideCar, y = e.noIsolation, b = e.inert, w = e.allowPinchZoom, E = e.as, x = e.gapMode, C = P(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), S = (n = [i, t],
            r = function(e) {
            ...
            a), R = O(O({}, C), c);
            return d.createElement(d.Fragment, null, h && d.createElement(g, {
                sideCar: V,
                removeScrollBar: v,
                shards: m,
                noIsolation: y,
                ...
                lockRef: i,
                gapMode: x
            }), s ? d.cloneElement(d.Children.only(f), O(O({}, R), {
                ref: S
            })) : d.createElement(void 0 === E ? "div" : E, O({}, R, {
                className: p,
                ref: S
            }), f))
        });
        ...
        var ei = !!eo && {
          ...
          , ed = function(e, t, n, r, o) {
            var a, i = (a = window.getComputedStyle(t).direction,
            "h" === e && "rtl" === a ? -1 : 1), u = i * r, c = n.target, l = t.contains(c), s = !1, d = u > 0, f = 0, p = 0;
            do {
                var v = es(e, c)
                  , h = v[0]
                  , m = v[1] - v[2] - i * h;
            ...
            return d && (o && 1 > Math.abs(f) || !o && u > f) ? s = !0 : !d && (o && 1 > Math.abs(p) || !o && -u > p) && (s = !0),
            s
        }
          , ef = function(e) {
          ...
          , eg = (l = function(e) {
            ...
            var u = d.useCallback(function(e, t) {
                ...
                var o, a = ef(e), u = n.current, c = "deltaX"in e ? e.deltaX : u[0] - a[0], l = "deltaY"in e ? e.deltaY : u[1] - a[1], s = e.target, d = Math.abs(c) > Math.abs(l) ? "h" : "v";
              ...
              , f = d.useCallback(function(t) {
                l(t.type, ep(t), t.target, u(t, e.lockRef.current))
            }, [])
              , p = d.useCallback(function(t) {
                l(t.type, ef(t), t.target, u(t, e.lockRef.current))
            }, []);
            d.useEffect(function() {
                return em.push(a),
                e.setCallbacks({
                ...
                document.addEventListener("wheel", c, ei),
                document.addEventListener("touchmove", c, ei),
                document.addEventListener("touchstart", s, ei),
                function() {
                    em = em.filter(function(e) {
                        return e !== a
                    }),
                    document.removeEventListener("wheel", c, ei),
                    document.removeEventListener("touchmove", c, ei),
                    document.removeEventListener("touchstart", s, ei)
                }
            }, []);
        ...
        X)
          , ey = d.forwardRef(function(e, t) {
            return d.createElement(K, O({}, e, {
                ref: t,
                sideCar: eg
            }))
        });
        ey.classNames = K.classNames;
        var eb = new WeakMap
          , ew = new WeakMap
          , eE = {}
          , ex = 0
          ...
          , eS = function(e, t, n, r) {
            ...
            function() {
                i.forEach(function(e) {
                    ...
                    eb.set(e, t),
                    a.set(e, o),
                    t || (ew.has(e) || e.removeAttribute(r),
                    ew.delete(e)),
        ...
        ;
        eF.displayName = eP;
        var e_ = "DialogOverlay"
          , eB = d.forwardRef( (e, t) => {
            let n = eW(e_, e.__scopeDialog)
              , {forceMount: r=n.forceMount, ...o} = e
              , a = ej(e_, e.__scopeDialog);
            return a.modal ? (0,
            w.jsx)(j.z, {
                present: r || a.open,
                children: (0,
        ...
        eK.displayName = ez;
        var eX = d.forwardRef( (e, t) => {
            let n = ej(ez, e.__scopeDialog)
              , r = d.useRef(null)
              , o = (0,
            p.e)(t, n.contentRef, r);
            return d.useEffect( () => {
                let e = r.current;
                if (e)
                    return eR(e)
          ...
          , eH = d.forwardRef( (e, t) => {
            ...
            w.jsx)(eY, {
                ...
                onCloseAutoFocus: t => {
                    ...
                    t.defaultPrevented || (r.current || n.triggerRef.current?.focus(),
                    t.preventDefault()),
                    r.current = !1,
                    o.current = !1
                }
          ...
          , eY = d.forwardRef( (e, t) => {
            ...
            return d.useEffect( () => {
                ...
                return document.body.insertAdjacentElement("afterbegin", e[0] ?? T()),
        ...
        var eG = "DialogClose"
          , eJ = d.forwardRef( (e, t) => {
            ...
            w.jsx)(y.WV.button, {
                ...
                ref: t,
                onClick: (0,
                f.M)(e.onClick, () => o.onOpenChange(!1))
            })
        }
        );
        function eQ(e) {
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
          ...
          , e9 = ({contentRef: e, descriptionId: t}) => {
            let n = e2("DialogDescriptionWarning")
    ...
    6536: function(e, t, n) {
        ...
        i.b)(d)
          , [v,h] = f(d)
          , m = r.forwardRef( (e, t) => {
            let {__scopeSwitch: n, name: i, checked: c, defaultChecked: d, required: f, disabled: p, value: h="on", onCheckedChange: m, form: g, ...y} = e
              , [E,x] = r.useState(null)
              , C = (0,
            a.e)(t, e => x(e))
              , S = r.useRef(!1)
              , R = !E || g || !!E.closest("form")
              , [k=!1,M] = (0,
            u.T)({
                prop: c,
                defaultProp: d,
            ...
            s.jsxs)(v, {
                ...
                s.jsx)(l.WV.button, {
                    ...
                    o.M)(e.onClick, e => {
                        M(e => !e),
                        R && (S.current = e.isPropagationStopped(),
